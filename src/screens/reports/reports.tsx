...
import {Column, FormContainer, Option, ReasonForCertificateInput, RowWrapper} from './styles.ts';
import {Controller, useForm} from 'react-hook-form';
import {HrReportType, reportsTabs, reportTypeOptions} from './types.ts';
...
import useVacationReport from '../../services/graphql/vacationReport/useVacationReport.ts';
...
const Reports = () => {
  ...
  const getTitle = reportsTabs.find(tab => tab.id === 1)?.title ?? '';
