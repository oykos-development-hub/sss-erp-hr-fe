...
export const generateDocxDocument = (props: AnnualLeavePartIDecisionDocumentProps) => {
  const {serialNumber, date, year, numberOfDays, fullName, jobTitle, department, currentUser} = props;
        ...
        children: [
          ...
          new Paragraph({
            ...
            children: [
              new TextRun({
                size: 22,
                text: '       Na osnovu člana 69 Zakona o državnim službenicima i namještenicima („Sl.list CG“, br.2/18,34/19 i 8/21), člana 85 tačke 1 i 3 Zakona o radu („Sl.list CG“,br.74/19 i 8/21, 59/21, 68/21 i 145/21)  i člana 3 Kolektivnog ugovora Sekretarijata Sudskog savjeta, sekretarka Sekretarijata Sudskog savjeta donosi',
              }),
            ],
          }),
          new Paragraph({
            ...
            children: [
              ...
              new TextRun({
                text: `o korišćenju I dijela godišnjeg odmora za ${year}. godinu`,
                bold: true,
                break: 1,
              }),
            ],
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: '       Imenovani će koristiti I dio godišnjeg odmora od ___ radnih dana u periodu  od __________ godine do __________ godine i dužan je da se javi na posao __________ godine.',
                bold: true,
              }),
            ],
          }),
