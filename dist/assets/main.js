...
`,LF=C.div(()=>me`
  ...
  `),FF=C.button(({disabled:e,theme:t,style:n,active:r})=>{const{white:o,gray200:i,gray400:a,gray600:s,gray900:l,primary500:u}=t.palette;return me`
      ...
      ${Object.assign({},n)}
    `}),zF=({style:e,theme:t=Oe,tabs:n,onChange:r,className:o,activeTab:i})=>w.createElement(NF,{className:o},w.createElement(LF,null,n==null?void 0:n.map(a=>w.createElement(FF,{key:a.id,theme:t,disabled:a.disabled,style:e,active:i===a.id,onClick:()=>r(a)},a.title))));var Yc;(function(e){e.bottom="bottom",e.left="left",e.right="right",e.top="top",e.topLeft="topLeft",e.topRight="topRight"})(Yc||(Yc={}));var yi;(function(e){e.standard="standard",e.filled="filled"})(yi||(yi={}));const Zo=me`
  content: "";
  position: absolute;
  width: 0.75em;
  height: 0.75em;
...
`,BF={top:me`
  ...
  `},UF=(e,t)=>t?BF[Yc[e]]:null,kr=C.div(({style:e,position:t,arrow:n,variant:r,theme:o,title:i})=>{const{white:a,primary500:s,gray900:l}=o.palette;return me`
    width: max-content;
    display: flex;
    flex-direction: column;
  ...
  `}),VF=(e,t)=>({bottom:me`
    ...
    `})[Yc[e]],HF=C.div(({position:e,tooltipWidth:t})=>me`
    position: relative;
...
`,Hz=({width:e,height:t,color:n})=>w.createElement(Vz,{width:e,height:t},w.createElement("svg",{viewBox:"25 25 50 50"},w.createElement("circle",{cx:"50",cy:"50",r:"20",fill:"none",stroke:n,strokeWidth:"4"}))),rl={sm:"24px",md:"48px",lg:"96px"},Wz=e=>{const{width:t,height:n,size:r,color:o}=e,i=r?rl[r]:t?typeof t=="string"?t:`${t}px`:rl.md,a=r?rl[r]:n?typeof n=="string"?n:`${n}px`:rl.md;return w.createElement(Hz,{width:i,height:a,color:o??U.palette.primary500})},Yz=C.ul`
  position: absolute;
  display: flex;
  flex-direction: column;
  border-radius: 8px;
...
`;C.div`
  ...
  padding: 32px 12px;
  border-radius: 8px;
`;const aH=e=>{var r;const{data:t}=zg({page:1,size:10,id:e.context.navigation.location.pathname.split("/")[4],job_tender_id:0}),n=t.items[0];return c.jsx(dn,{context:e.context,children:c.jsxs(Ir,{style:{marginTop:25},children:[c.jsx(Bg,{content:`KANDIDAT: ${n==null?void 0:n.first_name} ${n==null?void 0:n.last_name}`}),c.jsx(kn,{color:(r=H==null?void 0:H.palette)==null?void 0:r.gray200,height:"1px"}),c.jsxs(oH,{children:[c.jsxs(iH,{children:[c.jsx(_o,{label:"Tip Kandidata:",value:n==null?void 0:n.type}),c.jsx(_o,{label:"JMBG:",value:n==null?void 0:n.official_personal_id})]}),c.jsx(_o,{label:"Ime:",value:n==null?void 0:n.first_name}),c.jsx(_o,{label:"Prezime:",value:n==null?void 0:n.last_name}),c.jsx(_o,{label:"Broj lične karte:",value:n==null?void 0:n.official_personal_id}),c.jsx(_o,{label:"Datum rođenja:",value:ke(n==null?void 0:n.date_of_birth)}),c.jsx(_o,{label:"Državljanstvo:",value:n==null?void 0:n.nationality})]})]})})},sH=e=>{var a;const[t,n]=b.useState(1),{data:r}=zg({page:t,size:10,job_tender_id:0}),o=s=>{n(s+1)},i=s=>{e.context.navigation.navigate(`/hr/job-tenders/job-tender-applications/${s.id}`),e.context.breadcrumbs.add({name:`${s.id}`,to:`/hr/job-tenders/job-tender-applications/${s.id}`})};return c.jsx(dn,{context:e.context,children:c.jsxs(Ir,{style:{marginTop:25},children:[c.jsx(Bg,{content:"PREGLED SVIH KANDIDATA"}),c.jsx(kn,{color:(a=H==null?void 0:H.palette)==null?void 0:a.gray200,height:"1px"}),c.jsx(yt,{tableHeads:GO,data:r.items||[],style:{marginBottom:22},onRowClick:i}),c.jsx(qo,{pageCount:r.total/10,onChange:o,variant:"filled",itemsPerPage:2,previousLabel:"Previous",nextLabel:"Next",pageRangeDisplayed:3})]})})},lH=C.div``,ha=C.div`
  display: flex;
`,uH=C.div`
  display: flex;
  gap: 20px;
...
`,OH=C.div`
  ...
  align-items: center;
  gap: 4px;
`;let jH=(e=21)=>crypto.getRandomValues(new Uint8Array(e)).reduce((t,n)=>(n&=63,n<36?t+=n.toString(36):n<62?t+=(n-26).toString(36).toUpperCase():n>62?t+="-":t+="_",t),"");const EH=()=>{const[e,t]=b.useState(!1);return{loading:e,mutate:async(r,o,i)=>{t(!0);const a=await Z.judgeResolutionInsert(r);if(a.status===Ne.success){const s=a.item?a.item.id:0;o&&o(s)}else i&&i();t(!1)}}},CH={available_slots_presidents:0,available_slots_judges:0,number_of_judges:0,number_of_presidents:0,number_of_employees:0,number_of_relocated_judges:0,number_of_suspended_judges:0},P1=({context:e,isNew:t})=>{var S;const[n,r]=b.useState(!t),{organizationUnits:o}=Gn(),i=e.navigation.location.pathname.split("/")[4],{data:a,refetch:s}=KO({page:1,size:1e3}),{mutate:l}=EH(),u=a==null?void 0:a.find(k=>k.id===Number(i)),d=b.useMemo(()=>{const k={};return o==null||o.filter(O=>!!O.id&&!O.parent_id).forEach(O=>{var E,D;k[O.id]=u?(D=(E=u==null?void 0:u.items)==null?void 0:E.find(P=>P.organization_unit.id===O.id))==null?void 0:D.available_slots_judges:""}),{id:(u==null?void 0:u.id)??0,user_profile_id:1,serial_number:(u==null?void 0:u.serial_number)??"",year:u!=null&&u.year?{id:u==null?void 0:u.year,title:u==null?void 0:u.year}:null,items:k}},[o,u]),f=b.useMemo(()=>o.filter(k=>!k.parent_id&&k.id).map(k=>{var E;return{...((E=u==null?void 0:u.items)==null?void 0:E.find(D=>D.organization_unit.id===k.id))??{...CH,id:jH()},organization_unit:{id:k.id,title:k.title}}}),[o,u]),{register:p,handleSubmit:y,formState:{errors:g},control:_,reset:x}=_t({defaultValues:d}),h={title:"Odluka o broju sudija",accessor:"available_slots_judges",type:"custom",renderContents:(k,O)=>c.jsx(xe,{...p(`items.${O.organization_unit.id}`,{required:"Ovo polje je obavezno"}),disabled:n})},m=(k,O)=>{var D;r(!0);const E={id:k.id,serial_number:k.serial_number,year:((D=k.year)==null?void 0:D.id)??"",active:!0,items:Object.keys(k.items).map(P=>{var R;return{organization_unit_id:Number(P),number_of_judges:Number(k.items[P]),number_of_presidents:1,id:((R=u==null?void 0:u.items.find(B=>B.organization_unit.id===Number(P)))==null?void 0:R.id)??0}})};l(E,P=>{r(!0),e.alert.success("Uspješno sačuvano."),O?(e.navigation.navigate("/hr/judges/number-decision"),e.breadcrumbs.remove()):(s(),e.navigation.navigate(`/hr/judges/number-decision/${P}`))},()=>{e.alert.error("Greška. Promjene nisu sačuvane.")})},v=b.useMemo(()=>{const k=[...WO(5).map(O=>({id:O.id.toString(),title:O.title.toString()}))];return a?k.filter(O=>!a.find(E=>E.year===O.id)):[]},[a]);return b.useEffect(()=>{d&&x(d)},[d]),c.jsx(dn,{context:e,children:c.jsxs(Cs,{children:[c.jsx(Bg,{variant:"bodyMedium",content:"DETALJI ODLUKE"}),c.jsx(kn,{color:"#615959",height:"1px"}),c.jsx(kH,{titleElement:c.jsxs(wH,{children:[c.jsx(xe,{...p("serial_number",{required:"Redni broj je obavezan"}),label:"REDNI BROJ:",style:{width:300},error:(S=g.serial_number)==null?void 0:S.message,placeholder:"Unesite redni broj",disabled:n}),c.jsx(te,{control:_,rules:{required:"Godina je obavezna"},name:"year",render:({field:{onChange:k,name:O,value:E}})=>{var D;return c.jsx(SH,{label:"GODINA:",name:O,options:v,value:E,onChange:k,placeholder:"Odaberite godinu",error:(D=g.year)==null?void 0:D.message,isDisabled:n})}})]}),tableHeads:[...w1.slice(0,2),h,...w1.slice(3)],data:f||[]}),c.jsx(xH,{children:c.jsx(OH,{children:n?c.jsx(Fe,{content:"Uredi",variant:"secondary",onClick:()=>r(!1)}):c.jsx(Fe,{content:"Sačuvaj ",variant:"secondary",onClick:y(k=>m(k,!0))})})})]})})},PH=({context:e})=>c.jsx(dn,{context:e,children:c.jsxs(Cs,{children:[c.jsx(Xd,{content:"DODAVANJE NOVOG ZAPOSLENOG"}),c.jsx(kn,{}),c.jsx(HO,{context:e})]})}),DH=/\/hr\/employees(?!\/add-new)(\/.)?/,$H=/^\/hr\/systematization\/systematization-details(?:\/(\d+))?$/,MH=/^\/hr\/job-tenders\/job-tenders-list$/,TH=/^\/hr\/job-tenders\/job-tenders-list\/\d+/,AH=/^\/hr\/job-tenders\/job-tender-applications$/,RH=/^\/hr\/job-tenders\/job-tender-applications\/\d+/,IH=/^\/hr\/judges\/number-decision\/\d+/,NH=e=>{var o,i;const t=(i=(o=e==null?void 0:e.navigation)==null?void 0:o.location)==null?void 0:i.pathname,n=Object.freeze({...e});return(()=>t==="/hr"?n.navigation.navigate("employees"):t==="/hr/organization-units"?c.jsx(kV,{context:n}):DH.test(t)?c.jsx(pV,{context:n}):t==="/hr/systematization"?c.jsx(xV,{context:n}):t==="/hr/revision-recommendations"?c.jsx(S7,{context:n}):t==="/hr/job-positions"?c.jsx(c6,{context:n}):MH.test(t)?c.jsx(eH,{context:n}):TH.test(t)?c.jsx(bH,{context:n}):AH.test(t)?c.jsx(sH,{context:n}):RH.test(t)?c.jsx(aH,{context:n}):$H.test(t)?c.jsx(a7,{context:n}):t==="/hr/judges"?n.navigation.navigate("judges/number-decision"):t==="/hr/judges/number-decision"?c.jsx(I7,{context:n}):t==="/hr/judges/number-decision/new-decision"?c.jsx(P1,{context:n,isNew:!0}):IH.test(t)?c.jsx(P1,{context:n}):t==="/hr/judges/overview-judges-presidents"?c.jsx(M7,{context:n}):t==="/hr/job-tenders"?n.navigation.navigate("job-tenders/job-tenders-list"):t==="/hr/employees/add-new"?c.jsx(PH,{context:n}):c.jsx(SV,{context:n}))()},LH=e=>{const t=Su.createRoot(document.getElementById("root"));let n=null;const r="render"+Ef,o="unmount"+Ef,i=Ef+"-container";window[r]=(a,s)=>{n||(n=Su.createRoot(document.getElementById(a))),n.render(c.jsx(e,{...s}))},window[o]=()=>{n==null||n.unmount(),n=null},document.getElementById(i)||t.render(c.jsx(e,{}))};LH(e=>c.jsx(w.StrictMode,{children:c.jsx(NH,{...e})}));
